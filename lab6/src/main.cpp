...
int main() {
    ...
    std::cout << "1 - Normal | 2 - Invert | 3 - Blur | 4 - Canny | 5 - PIP (67)\n";
    ...
    while (true) {
        ...
        cv::Mat processedFrame = frameProcessor.process(frame, keyProcessor.getMode(), keyProcessor.isOverlayActive());
